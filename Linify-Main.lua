...
for I,SongTable in pairs(CurrentSongList) do 
    ...
    if Success then
        ...
        SongInnerButton.MouseEnter:Connect(function()ToolTipHover(tostring(SongCustomName),"Asset Id:"..tostring(CurrentSongId))end)
        ...
        AssetCreator.Text = "Asset Owned By:"..tostring(AssetOwner) or "Nil"
